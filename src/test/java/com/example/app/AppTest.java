...
public class AppTest
    ...
    public void test() {
        ...
        Assert.assertTrue(
                !(flightMap.getFlightsFromAToB(airport1.getCode(), airport3.getCode(), LocalDate.now()).isEmpty()));
        ...
        Reservation reservation = new Reservation(
                flightMap.getFlightsFromAToB(airport1.getCode(), airport3.getCode(), LocalDate.now()).get(0),
                "John_Doe");
